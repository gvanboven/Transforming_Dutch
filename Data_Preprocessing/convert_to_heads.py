"""
This code is taken directly from Dobrovolskii (2021): https://github.com/vdobrovolskii/wl-coref
-----------------------------------------------
Use this file to add the heads to jsonlines formatted data
Run the file as follows:
python conver_to_heads.py path/to/jsonlines-data 
"""
...
DATA_DIR = "../Data/jsonlines_regular"
FILENAME = "sonar_{}{}.jsonlines"
